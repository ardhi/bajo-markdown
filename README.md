...
Markdown support for [Bajo Framework](https://github.com/ardhi/bajo)
...
Next, open the file located at ```{data-dir}/config/.plugins``` and add ```bajo-markdown```

## Documentations

- [Config Object](tutorial/00-config.md)
- [API](https://ardhi.github.io/bajo-markdown)
